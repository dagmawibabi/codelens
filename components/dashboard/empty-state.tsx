 ...
 * the user to run Projectlens against a real project or explore the demo data.
 */
  ...
  return (
    <div className="flex min-h-[60svh] flex-col items-center justify-center px-4 py-16 text-center">
      ...
      <p className="mt-2 max-w-md text-pretty text-sm leading-relaxed text-muted-foreground">
        Run Projectlens against a project to populate every surface with real lint, type, security,
      ...
      <div className="mt-8 flex items-center gap-2 rounded-sm border border-border bg-secondary/40 px-3 py-2 font-mono text-xs text-muted-foreground">
        ...
        <span>
          Or run <span className="font-semibold text-foreground">Projectlens</span> in your project directory
        </span>
      </div>
    </div>
  )
